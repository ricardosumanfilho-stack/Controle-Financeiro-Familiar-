  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-6">
        ...
        {/* Auto-save Status Card with 1-Week Retention */}
        <div className="p-4 rounded-xl border border-blue-200 dark:border-blue-900/50 bg-blue-50/50 dark:bg-blue-950/20 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div>
              ...
              {lastSavedTime && (
                <p className="text-[11px] font-medium text-slate-600 dark:text-slate-300 mt-0.5">
                  Última gravação registrada: {lastSavedTime}.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 w-full md:w-auto shrink-0">
            <button
              ...
              className="flex-1 md:flex-initial px-4 py-2 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-700 transition-all flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
            >
